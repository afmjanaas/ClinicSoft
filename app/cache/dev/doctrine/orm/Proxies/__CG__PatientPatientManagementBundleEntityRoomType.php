...
namespace Proxies\__CG__\Patient\PatientManagementBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RoomType extends \Patient\PatientManagementBundle\Entity\RoomType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'type', 'price', 'id', 'room');
        }
